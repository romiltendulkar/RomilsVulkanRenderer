...
VModel VModel::loadModelFromFile(const VulkanApplication& vulkan_context, const std::string& path, const vk::Sampler& texture_sampler, const vk::DescriptorPool& descriptor_pool,
